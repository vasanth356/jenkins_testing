...
ml_testing = HyperoptModelSelection(cfg['location']['today_data_with_target'],'version1',data,test_data,cfg['experiment_details']['name'], cfg['model_parameters']['problem_type'])
